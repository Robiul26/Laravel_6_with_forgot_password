                    ...
                    <table id="datatable" class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="datatable_info">
                      ...
                      <tr role="row" class="odd">
                          ...
                          <td>
                              ...
                              <a class="btn btn-danger" href="#" onclick="event.preventDefault(); document.getElementById('edit-form-{{$user->id}}').submit();"> Delete</a>

                              <form id="edit-form-{{$user->id}}" action="{{ url('/users/'.$user->id) }}" method="POST"
                                  style="display: none;">
                                  @method('delete')
                                  @csrf
                              </form>
