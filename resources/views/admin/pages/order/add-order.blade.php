                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="storeId" id="storeId">
                                    <option value="15">Creation Edge Delivery Office</option>
                                </select>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="deliveryType" id="deliveryType">
                                            <option value="48" selected>Normal Delivery(48-72 hours)</option>
                                            <option value="12" disabled>On Demand Delivery (same day)</option>
                                        </select>
