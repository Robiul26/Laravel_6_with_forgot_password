...
<h3 class="text-center"> <a class="btn btn-info" href="{{url('invoice-pdf-show')}}"><i class="fa fa-folder-open"></i> ViewPDF</a>
  Today Orders
  <a class="btn btn-info" href="{{url('invoice-pdf-download')}}"><i class="fa fa-download"></i> SavePDF</a></h3>
@endsection
                ...
                <div class="row">
                  ...
                  <table id="datatable" class="table table-responsive table-striped table-bordered" style="width: 100%;" role="grid" aria-describedby="datatable_info">
                      ...
                      <tr role="row" class="odd">
                        <td>
                          <a href="{{ url('/single_report/'.$order->id) }}" class="btn btn-primary btn-sm">{{$order->id}}</a>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <a href="{{ url('/single_report/'.$order->id) }}" class="btn btn-primary btn-sm">ViewPDF</a>
                        </td>
                      </tr>
                      @endforeach
                    </table>
