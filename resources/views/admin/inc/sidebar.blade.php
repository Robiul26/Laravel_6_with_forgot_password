          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                <h3>Live On</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-user"></i>Post's <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-sitemap"></i>Access <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        </li><li><a>Role<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
