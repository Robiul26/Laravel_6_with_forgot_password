<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{url('dashboard')}}" class="site_title text-center"><img width="44" src="{{asset('uploads/logo.jpg')}}" alt="Company logo"> CMIS</a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-cart-plus"></i>Order Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('orders/create')}}">Add Order</a></li>
